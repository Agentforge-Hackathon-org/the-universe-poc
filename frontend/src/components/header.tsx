      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center">
          <p className="inline-flex items-center space-x-3">
            <a
              href="https://github.com/Agentforge-Hackathon-org/the-universe-poc"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="https://i.imgur.com/RF0S56c.png"
                alt="monolith in a holographic room in bright saturated colors"
                className="the-universe-logo"
                width="63"
              />
              <path
                fillRule="evenodd"
          ...
          <span className="text-white font-bold text-xl">The Universe</span>
        </p>
        {session ? (
